...
import Cfcaptaintocreatetrips from '../../src/Cfcaptaintocreatetrips';
...
const feature = loadFeature('./__tests__/features/Cfcaptaintocreatetrips-scenario.feature');
...
defineFeature(feature, (test) => {
	...
	beforeEach(() => {
		...
		forcedUpdateSpy = jest.spyOn(Cfcaptaintocreatetrips.prototype, 'forceUpdate');
	});

	test('User can input text into Cfcaptaintocreatetrips', ({ given, when, then }) => {
	...
	test('User navigates away from Cfcaptaintocreatetrips', ({ given, when, then }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Cfcaptaintocreatetrips;
		...
		then('I can dismiss Cfcaptaintocreatetrips', () => {
	...
	test('Cfcaptaintocreatetrips has event listeners for screen size changes added', ({ given, when, then }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Cfcaptaintocreatetrips;
	...
	test('Cfcaptaintocreatetrips resizing events are triggered', ({ given, when, then }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Cfcaptaintocreatetrips;
