...
import Rolesandpermissions2 from '../../src/Rolesandpermissions2';
const navigation = require('react-navigation');

const screenProps = {
	navigation: navigation,
	id: 'Rolesandpermissions2',
};

const feature = loadFeature('./__tests__/features/Rolesandpermissions2-scenario.feature');
...
defineFeature(feature, (test) => {
	...
	beforeEach(() => {
		...
		forcedUpdateSpy = jest.spyOn(Rolesandpermissions2.prototype, 'forceUpdate');
	});

	test('User can input text into Rolesandpermissions2', ({ given, when, then }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Rolesandpermissions2;

		given('I am a User loading Rolesandpermissions2', () => {
			exampleBlockA = shallow(<Rolesandpermissions2 {...screenProps} />);
		});

		when('I navigate to the Rolesandpermissions2', () => {
			instance = exampleBlockA.instance() as Rolesandpermissions2;
		});
	...
	test('User navigates away from Rolesandpermissions2', ({ given, when, then }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Rolesandpermissions2;
		...
		then('I can dismiss Rolesandpermissions2', () => {
	...
	test('Rolesandpermissions2 has event listeners for screen size changes added', ({ given, when, then }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Rolesandpermissions2;
	...
	test('Rolesandpermissions2 resizing events are triggered', ({ given, when, then }) => {
		let exampleBlockA: ShallowWrapper;
		let instance: Rolesandpermissions2;
