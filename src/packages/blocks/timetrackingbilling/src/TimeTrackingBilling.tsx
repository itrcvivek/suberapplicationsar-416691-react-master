...
import { dimensions,Colors } from "./components/utils";
...
export default class TimeTrackingBilling extends TimeTrackingBillingController {
  ...
  // Customizable Area Start
  renderUserTTList = (item:{id: number, full_name: string}) => {
  ...
  render() {
    ...
    <TouchableOpacity testID="btnDrawer" onPress={this.props.navigation?.goBack?.bind(this,null)}>
                  <Image source={require('../assets/back.png')} style={styles.backbtnIcon} />
                </TouchableOpacity>
          <Typography
