...
import CfcalculatethecostoftripsController, {
  Props,
  configJSON,
} from "./CfcalculatethecostoftripsController";

export default class Cfcalculatethecostoftrips extends CfcalculatethecostoftripsController {
