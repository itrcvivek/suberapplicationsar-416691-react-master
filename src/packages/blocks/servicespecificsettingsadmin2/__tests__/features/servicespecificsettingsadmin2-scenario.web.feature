Feature: servicespecificsettingsadmin2
    ...
    Scenario: User navigates to servicespecificsettingsadmin2 and inputs text
    ...
    Scenario: User navigates to servicespecificsettingsadmin2 and inputs a password
        Given I am a User loading servicespecificsettingsadmin2
        When I navigate to the servicespecificsettingsadmin2
