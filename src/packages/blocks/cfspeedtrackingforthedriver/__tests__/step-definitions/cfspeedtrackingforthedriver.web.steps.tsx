...
import Cfspeedtrackingforthedriver from '../../src/Cfspeedtrackingforthedriver.web';
...
const feature = loadFeature('./__tests__/features/Cfspeedtrackingforthedriver-scenario.web.feature');
...
defineFeature(feature, (test) => {
	...
	test('User navigates to Cfspeedtrackingforthedriver and inputs text', ({ given, when, then }) => {
	...
	test('User navigates to Cfspeedtrackingforthedriver and inputs a password', ({ given, when, then, and }) => {
		let exampleBlockA: ReactWrapper;
		let instance: Cfspeedtrackingforthedriver;

		given('I am a User loading Cfspeedtrackingforthedriver', () => {
			exampleBlockA = mount(<Cfspeedtrackingforthedriver {...screenProps} />);
		});
