...
import CfspeedtrackingforthedriverController, {
  Props,
  configJSON,
} from "./CfspeedtrackingforthedriverController";

export default class Cfspeedtrackingforthedriver extends CfspeedtrackingforthedriverController {
