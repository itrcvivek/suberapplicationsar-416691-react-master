...
import CfcaptaintocreatetripsController, {
  Props,
  configJSON,
} from "./CfcaptaintocreatetripsController";

export default class Cfcaptaintocreatetrips extends CfcaptaintocreatetripsController {
