...
import SocialMediaAccountController, {
  Props,
} from "../../social-media-account/src/SocialMediaAccountController";
...
class SocialMediaAccountRegistrationScreen extends SocialMediaAccountController {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          {configJSON.signUpTitleText} {/*UI Engine::From Sketch*/}
        </Text>

        <Text
          style={styles.titleWhySignUp} //UI Engine::From Sketch
        >
          {configJSON.signUpBodyText} {/*UI Engine::From Sketch*/}
        </Text>
