...
import CfsuggestavailabletripstothetravellerController, {
  Props,
  configJSON,
} from "./CfsuggestavailabletripstothetravellerController";

export default class Cfsuggestavailabletripstothetraveller extends CfsuggestavailabletripstothetravellerController {
