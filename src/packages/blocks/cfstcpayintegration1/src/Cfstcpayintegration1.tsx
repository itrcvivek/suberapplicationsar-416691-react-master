...
import Cfstcpayintegration1Controller, {
  Props,
  configJSON,
} from "./Cfstcpayintegration1Controller";

export default class Cfstcpayintegration1 extends Cfstcpayintegration1Controller {
